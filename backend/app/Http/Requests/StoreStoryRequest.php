...
class StoreStoryRequest extends FormRequest
{
    ...
    {
        return [
            'title' => 'required|string|max:300|unique:stories,title',
            'slug' => 'nullable|string|max:320|unique:stories,slug',
            'region_id' => 'required|integer|exists:regions,id',
            'creator_id' => 'nullable|integer|exists:creators,id',
            'category' => 'required_without:type|string|max:120',
            'type' => 'nullable|string|in:travel,product-origin,culture,festival,history,craft',
