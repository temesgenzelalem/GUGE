...
class StoreCreatorRequest extends FormRequest
{
    ...
    {
        return [
            'full_name' => 'required_without:name|string|max:200|unique:creators,full_name',
            'name' => 'sometimes|string|max:200|unique:creators,name',
            'username' => 'nullable|string|max:100|unique:creators,username',
            'slug' => 'nullable|string|max:220|unique:creators,slug',
